<div class="hero-unit" style="overflow:hidden;">
  ...
  <div id="cont-form-feedback" class="cont-form seccion">
    <form id="form-feedback" method="post" action="<?php echo URL; ?>feedback/paFeedback" enctype="multipart/form-data">
      <div style="float: left">
        <label>Cargar Excel</label>
        <div id="cont-arch-feedback">
          <input id="arch-feedback" class="input-file" type="file" name="excel" size="40" ><br />
        </div>
        <label>Curso</label>
