<div class="hero-unit" style="overflow:hidden;">
  ...
  <div style="display: inline-block;">
    ...
    <div class="btn-group btn-menu-usu">
      <a class="boton btn btn-inverse" href="#" style="margin-right:0px; margin-bottom:0px;">Buscar Usuario</a>
      <a class="boton btn btn-inverse dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
      <ul class="dropdown-menu">
        <li><a id="por-rut" class="buscar" href="#">Por Rut</a></li>
        <li><a id="por-nom" class="buscar" href="#">Por Nombre</a></li>
        <li><a id="por-ap" class="buscar" href="#">Apellido Paterno</a></li>
        <li><a id="por-am" class="buscar" href="#">Apellido Materno</a></li>
      </ul>
    </div>
  </div>
